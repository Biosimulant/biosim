...
2. Update `src/biosim/__about__.py` with a new version (example: `0.0.15`).
...
git commit -m "Bump version to 0.0.15"
...
- Explicit version: `bash scripts/release_pypi.sh 0.0.15`
